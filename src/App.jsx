...
function LandingPage({ onEnter, creators, exiting }) {
  ...
  const platforms = [
    {
      name: "TikTok", top: "8%", left: "6%", dur: 5.2, delay: 0,
      bg: "#010101", color: "#ffffff",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:28,height:28}}><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.32 6.32 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.78a4.85 4.85 0 0 1-1.01-.09z"/></svg>,
    },
    {
      name: "Instagram", top: "5%", left: "38%", dur: 6.8, delay: 0.5,
      bg: "linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)", color: "#ffffff",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:28,height:28}}><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z"/></svg>,
    },
    {
      name: "YouTube", top: "10%", right: "7%", dur: 5.8, delay: 1.1,
      bg: "#FF0000", color: "#ffffff",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:28,height:28}}><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>,
    },
    {
      name: "Spotify", top: "52%", left: "3%", dur: 4.9, delay: 0.3,
      bg: "#1DB954", color: "#ffffff",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:28,height:28}}><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg>,
    },
    {
      name: "SoundCloud", top: "55%", right: "4%", dur: 6.2, delay: 0.8,
      bg: "#FF5500", color: "#ffffff",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:28,height:28}}><path d="M1.175 12.225c-.017 0-.034.002-.05.006-.052-2.645 2.017-4.806 4.618-4.806.677 0 1.32.145 1.9.405C8.4 5.969 10.175 4.8 12.15 4.8c2.494 0 4.523 2.028 4.523 4.525 0 .045-.002.09-.004.135A3.19 3.19 0 0 1 18 9.15c1.763 0 3.192 1.432 3.192 3.194 0 1.76-1.429 3.19-3.192 3.19H1.175C.527 15.534 0 15.006 0 14.36c0-.646.527-1.174 1.175-1.135z"/></svg>,
    },
    {
      name: "X", bottom: "8%", left: "16%", dur: 5.5, delay: 1.4,
      bg: "#000000", color: "#ffffff",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:26,height:26}}><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
    },
    {
      name: "Snapchat", bottom: "6%", right: "16%", dur: 6.0, delay: 0.6,
      bg: "#FFFC00", color: "#000000",
      svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{width:26,height:26}}><path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12 1.033-.301.165-.09.337-.135.514-.135.175 0 .344.04.493.12.45.239.734.709.734 1.255 0 .796-.556 1.395-1.33 1.5-.023.003-.341.054-.557.093.033.124.078.249.123.373.22.586.579 1.541 1.31 2.371.173.2.347.394.53.585.406.427.8.84 1.125 1.28.51.68.766 1.37.766 2.052 0 .984-.464 1.83-1.297 2.378-.785.51-1.896.796-3.091.796-.355 0-.718-.025-1.077-.075l-.003-.001c-.317-.043-.608-.064-.884-.064-.26 0-.508.02-.742.063-.493.09-1.03.278-1.598.472-.68.23-1.386.47-2.187.47-.8 0-1.507-.24-2.187-.47-.568-.194-1.105-.382-1.598-.472-.234-.043-.482-.063-.742-.063-.276 0-.567.021-.884.064l-.003.001c-.359.05-.722.075-1.077.075-1.195 0-2.306-.286-3.091-.796-.833-.548-1.297-1.394-1.297-2.378 0-.682.256-1.372.766-2.052.325-.44.719-.853 1.125-1.28.183-.191.357-.385.53-.585.731-.83 1.09-1.785 1.31-2.371.045-.124.09-.249.123-.373-.216-.039-.534-.09-.557-.093-.774-.105-1.33-.704-1.33-1.5 0-.546.284-1.016.734-1.255.149-.08.318-.12.493-.12.177 0 .349.045.514.135.374.181.733.285 1.033.301.198 0 .326-.045.401-.09l-.03-.51-.003-.06c-.104-1.628-.23-3.654.299-4.847C7.859 1.069 11.216.793 12.206.793z"/></svg>,
    },
  ];
        ...
        <div className="relative mx-auto" style={{ height: "280px", maxWidth: "700px" }}>
          {platforms.map((p, i) => (
            <div key={i} style={{
              ...
              <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)", fontWeight: 600 }}>{p.name}</span>
            </div>
          ))}
